...
import { resourceQuotaColumns } from "@/lib/k8s/columns/core";
...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("core", "resourcequotas", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
  ...
  const kubectlCmd = nsFilter === "all"
    ...
    : `kubectl get resourcequotas -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Resource Quotas" count={pagination?.totalItems} subtitle="v1 · core · all namespaces"  kubectlCmd={kubectlCmd} resourceKey="resourcequotas" />
