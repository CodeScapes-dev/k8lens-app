...
export default function Page() {
  ...
  const kubectlCmd = nsFilter === "all"
    ...
    : `kubectl get cronjobs -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="CronJobs" count={pagination?.totalItems} subtitle="batch/v1 · all namespaces" kubectlCmd={kubectlCmd} resourceKey="cronjobs"><StatusSummary data={data} /></PageHeader>
