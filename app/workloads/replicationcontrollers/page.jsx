...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("core", "replicationcontrollers", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
