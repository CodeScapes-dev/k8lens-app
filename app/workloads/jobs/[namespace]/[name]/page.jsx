...
export default function JobDetailPage() {
  ...
  const diagCount = data ? diagnoseResource("job", data).length : 0;
    ...
    <div>
      ...
      <div className="px-4 sm:px-7 py-5">
        <DiagnosticsPrompt
          ...
          resourceLabel="Job"
          data={data}
          uid={data?.job?.metadata?.uid}
          activeTab={activeTab}
          onViewDiagnostics={() => setActiveTab("Diagnostics")}
        />
        {activeTab === "Diagnostics" && <DiagnosticsPanel resourceType="job" data={data} showEmpty />}
