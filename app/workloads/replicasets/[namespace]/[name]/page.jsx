...
export default function ReplicaSetDetailPage() {
  ...
  const diagCount = data ? diagnoseResource("replicaset", data).length : 0;
    ...
    <div>
      ...
      <div className="px-4 sm:px-7 py-5">
        <DiagnosticsPrompt
          ...
          data={data}
          uid={data?.replicaSet?.metadata?.uid}
          activeTab={activeTab}
          onViewDiagnostics={() => setActiveTab("Diagnostics")}
        />
        {activeTab === "Diagnostics" && <DiagnosticsPanel resourceType="replicaset" data={data} showEmpty />}
        {activeTab === "Overview" && <OverviewTab rs={replicaSet} pods={pods} events={events} />}
