...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("core", "serviceaccounts", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
  ...
  const kubectlCmd = nsFilter === "all"
    ...
    : `kubectl get serviceaccounts -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Service Accounts" count={pagination?.totalItems} subtitle="v1 · core · all namespaces"  kubectlCmd={kubectlCmd} resourceKey="serviceaccounts" />
