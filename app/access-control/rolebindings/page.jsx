...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("rbac", "rolebindings", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
  ...
  const kubectlCmd = nsFilter === "all"
    ...
    : `kubectl get rolebindings -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Role Bindings" count={pagination?.totalItems} subtitle="rbac.authorization.k8s.io/v1 · all namespaces"  kubectlCmd={kubectlCmd} resourceKey="rolebindings" />
