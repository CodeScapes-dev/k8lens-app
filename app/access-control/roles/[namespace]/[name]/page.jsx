...
export default function RoleDetailPage() {
  ...
  const diagCount = data ? diagnoseResource("role", data).length : 0;
    ...
    <div>
      ...
      <div className="px-4 sm:px-7 py-5">
        <DiagnosticsPrompt
          ...
          resourceLabel="Role"
          data={data}
          uid={data?.role?.metadata?.uid}
          activeTab={activeTab}
          onViewDiagnostics={() => setActiveTab("Diagnostics")}
        />
        {activeTab === "Diagnostics" && <DiagnosticsPanel resourceType="role" data={data} showEmpty />}
