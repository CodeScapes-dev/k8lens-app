...
import { roleColumns } from "@/lib/k8s/columns/rbac";
...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("rbac", "roles", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
