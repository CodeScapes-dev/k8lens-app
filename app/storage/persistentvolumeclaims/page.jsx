...
export default function Page() {
  ...
  const kubectlCmd = nsFilter === "all"
    ...
    : `kubectl get persistentvolumeclaims -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Persistent Volume Claims" count={pagination?.totalItems} subtitle="v1 · core · all namespaces" kubectlCmd={kubectlCmd} resourceKey="persistentvolumeclaims"><StatusSummary data={data} /></PageHeader>
