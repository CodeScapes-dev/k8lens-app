...
export default function Page() {
  ...
  const kubectlCmd = nsFilter === "all"
    ? "kubectl get hpa -A"
    : `kubectl get hpa -n ${nsFilter}`;

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Horizontal Pod Autoscalers" count={pagination?.totalItems} subtitle="autoscaling/v2 · all namespaces"  kubectlCmd={kubectlCmd} resourceKey="horizontalpodautoscalers" />
