...
export default function Page() {
  ...
  const kubectlCmd = "kubectl get customresourcedefinitions";

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Custom Resource Definitions" count={pagination?.totalItems} subtitle="apiextensions.k8s.io/v1 · cluster-scoped"  kubectlCmd={kubectlCmd} resourceKey="customresourcedefinitions" />
