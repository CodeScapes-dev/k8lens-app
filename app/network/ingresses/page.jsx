...
import { ingressColumns } from "@/lib/k8s/columns/networking";
...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("networking", "ingresses", { listParams, namespace: nsFilter === "all" ? undefined : nsFilter });
