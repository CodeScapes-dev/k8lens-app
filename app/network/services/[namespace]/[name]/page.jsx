...
import { LayoutDashboardIcon, NetworkIcon, ShieldAlertIcon, BellIcon, TagIcon, ShareIcon, StethoscopeIcon } from "lucide-react";
...
export default function ServiceDetailPage() {
  ...
  const diagCount = data ? diagnoseResource("service", data).length : 0;
    ...
    <div>
      ...
      <div className="px-4 sm:px-7 py-5">
        <DiagnosticsPrompt
          ...
          data={data}
          uid={data?.service?.metadata?.uid}
          activeTab={activeTab}
          onViewDiagnostics={() => setActiveTab("Diagnostics")}
        />
        {activeTab === "Diagnostics" && <DiagnosticsPanel resourceType="service" data={data} showEmpty />}
