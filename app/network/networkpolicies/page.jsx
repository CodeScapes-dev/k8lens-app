...
export default function Page() {
  ...
  const { data, loading, refreshing, error, pagination } = useK8sResource("networking", "networkpolicies", { listParams });
  ...
  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Network Policies" count={pagination?.totalItems} subtitle="networking.k8s.io/v1 · all namespaces" />
