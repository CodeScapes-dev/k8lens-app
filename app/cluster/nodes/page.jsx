...
export default function Page() {
  ...
  const kubectlCmd = "kubectl get nodes";

  return (
    <div className="px-4 sm:px-6 py-5">
      <PageHeader title="Nodes" count={pagination?.totalItems} subtitle="v1 · core · cluster-scoped" kubectlCmd={kubectlCmd} resourceKey="nodes"><StatusSummary data={data} /></PageHeader>
