...
const resourceMap = {
  ingresses: {
    scope: "namespaced",
    listNamespaced: (c, ns) => c.networking.listNamespacedIngress({ namespace: ns }),
    listAll: (c) => c.networking.listIngressForAllNamespaces(),
    get: (c, ns, name) => c.networking.readNamespacedIngress({ namespace: ns, name }),
  },
  ingressclasses: {
    scope: "cluster",
    list: (c) => c.networking.listIngressClass(),
    get: (c, _ns, name) => c.networking.readIngressClass({ name }),
  },
  networkpolicies: {
    scope: "namespaced",
    listNamespaced: (c, ns) => c.networking.listNamespacedNetworkPolicy({ namespace: ns }),
    listAll: (c) => c.networking.listNetworkPolicyForAllNamespaces(),
    get: (c, ns, name) => c.networking.readNamespacedNetworkPolicy({ namespace: ns, name }),
  },
};
